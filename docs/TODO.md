...
- Optimization
    - Review chatbot window height in gradio app
...
- UI:
    - 
- Features
    - Implement a credits indicator somewhere in the UI 
    ...
    - Integrate streaming (to avoid making the user wait, check docs/with_stream.py)
- LLM
